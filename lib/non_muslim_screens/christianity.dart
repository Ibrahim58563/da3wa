...
class ChristianityScreen extends StatefulWidget {
  ...
  const ChristianityScreen({super.key, required this.title});

  @override
  State<ChristianityScreen> createState() => _FastScreenState();
}

class _FastScreenState extends State<ChristianityScreen> {
  ...
  Future<void> readJson() async {
    ...
    setState(() {
      for (var topic in data[1]['topics']) {
